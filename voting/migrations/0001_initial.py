# Generated by Django 4.2.7 on 2023-12-21 16:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sex', models.CharField(choices=[('Prefer not to say', 'Prefer not to say'), ('Male', 'Male'), ('Female', 'Female')], default='Prefer not to say', max_length=20)),
                ('card_uid', models.CharField(max_length=12, unique=True)),
