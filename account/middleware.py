...
class AccountCheckMiddleWare(MiddlewareMixin):
    def process_view(self, request, view_func, view_args, view_kwargs):
        ...
        # Check if the current view is 'get_rfid'
        if modulename == 'account.views' and view_func.__name__ == 'get_rfid_data':
            return None  # Skip middleware processing for this view
        
        if modulename == 'account.views' and view_func.__name__ == 'get_latest_rfid_data':
            return None
